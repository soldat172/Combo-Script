    ...
    def auto_script_grey(self):   
        ...
        for x in AP_grey_list: 
            ...
            if keyboard.is_pressed('esc'):
                ...
                pass
        print(f'Colored {AP_grey_count} Grey APs')
