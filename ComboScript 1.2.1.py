...
def visioGuts(): # the internals to the Visio Tool. Determines how most of the program is run
    ...
    pyautogui.press('backspace'); pyautogui.press('esc'); pyautogui.press('tab'); pyautogui.press('tab'); pyautogui.press('enter'); pyautogui.typewrite(str(formatNumber)) # takes control of keyboard. hits backspace and types AP number
...
print('Version 1.2')
print('Use \"[\" for saving visio as a CAD drawing')
print('Use \"]\" for scaling and data extracting a CAD drawing')
print('Use \"\\\" for starting the Visio Tool')
